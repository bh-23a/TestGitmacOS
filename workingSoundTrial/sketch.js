...
function preload() {
  ...
  // added in new audio for happy, previous one was incomabitable.
  // cut down audio files so that they do not overlap
  happySound = loadSound('kids-cheering-unintelligible.wav');
  sadSound = loadSound('sadViolin.mp3');
  angrySound = loadSound('angryElep.wav');
}
